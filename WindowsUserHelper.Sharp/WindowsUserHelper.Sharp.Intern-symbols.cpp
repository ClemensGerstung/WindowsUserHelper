...
extern "C" { void c__N_wuh_S__UserImpersonation__UserImpersonation(void* __instance) { new (__instance) wuh::_UserImpersonation(); } }
extern "C" { void c__N_wuh_S__UserImpersonation__UserImpersonation___1__N_wuh_S__UserImpersonation(void* __instance, const wuh::_UserImpersonation& _0) { new (__instance) wuh::_UserImpersonation(_0); } }
wuh::_UserImpersonation& (wuh::_UserImpersonation::*_1)(wuh::_UserImpersonation&&) = &wuh::_UserImpersonation::operator=;
